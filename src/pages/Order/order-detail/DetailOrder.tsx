...
import { useCancelOrderMutation, useDetailOrderQuery } from '../../../api-slice/orderAPI';
      ...
      <div>
         ...
         <div className='order-main'>
            ...
            {detailOrder?.status !== 'Đã hủy' && remainingTimeMessage ? (
               ...
               <button className='bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-4 rounded border border-gray-400 hover:border-gray-500'>
                  ĐÃ HỦY
               </button>
            )}
         </div>
