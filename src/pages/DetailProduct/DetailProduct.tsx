                ...
                <div className='py-9 md:px-10 lg:px-60'>
                    <div className='flex justify-center items-center md:flex-row flex-col gap-8'>
                        ...
                        <div className='  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center'>
                            ...
                            <button onClick={handleAddToCart} className='focus:outline-none focus:ring-2 hover:bg-hightLigh hover:text-white duration-300 focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6'>
                                Add to shopping bag
                            </button>
                        </div>
