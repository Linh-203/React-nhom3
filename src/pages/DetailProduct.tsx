               ...
               <div className='flex justify-center items-center lg:flex-row flex-col gap-8'>
                  ...
                  <div className='  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center'>
                     <p className=' focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600'>
                        Home / {products.categoryId.name} / {products.name}
                     </p>
                     ...
                     <div className='lg:mt-11 mt-10'>
                        ...
                        <div className='flex flex-row justify-between items-center mt-4'>
                           <p className=' font-medium text-base leading-4 text-gray-600'>
                              Availability: {products.stock > 0 ? 'In stock' : 'Out of stock'}
                           </p>
                        </div>
                  ...
                  <div className='w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10'>
                     <div>
                        ...
                        <p className='text-normal text-base leading-6 text-gray-600 mt-4'>
                           Here are all the great cocktail recipes you should know how to make, from the margarita to
                           the whiskey sour. Cheers!{' '}
                        </p>
                     </div>
                     <div>
                        <p className='font-semibold text-xl leading-5 text-gray-800 lg:mt-10 mt-9'>Durable hardware</p>
                        <p className='text-normal text-base leading-6 text-gray-600 mt-4'>
                           Product durability is a key aspect of achieving a circular economy. ... Moreover, enhancing
                           the durability of individual hardware components{' '}
                        </p>
                     </div>
                     <div>
                     ...
                     <div>
                        ...
                        <p className='text-normal text-base leading-6 text-gray-600 mt-4'>
                           Minimalist interior design is very similar to modern interior design and involves using the
                           bare essentials{' '}
                        </p>
                     </div>
                  </div>
