            ...
            orders?.map((item: any, index: number) => {
               ...
               return (
                  <tr>
                     ...
                     <td className='py-2 px-4 border-b text-center'>
                        <span className='inline-block bg-blue-200 text-green-800 rounded-full px-3 py-1 text-sm font-semibold'>
                     ...
                     <td className='py-2 px-4 border-b text-center'>
                        <Link
                           ...
                           className='inline-block bg-green-200 text-green-800 rounded-full px-3 py-1 text-sm font-semibold'
                        >
                           Chi tiết
                        </Link>
                     </td>
